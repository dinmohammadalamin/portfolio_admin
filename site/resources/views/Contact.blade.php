    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <hr>
                <p class="footer-text"><i class="fas fa-map-marker-alt"></i> Rajshahi <i class="fas ml-2 fa-phone"></i>   01755182352 <i class="fas ml-2 fa-envelope"></i>  din@gmail.com</p>
                <h3 class="service-card-title">Send Message</h3>
                <div class="form-group ">
                    <input id="contactNameId" type="text" class="form-control w-100" placeholder="Name">
                </div>
                <div class="form-group">
                    <input id="contactMobileId" type="text" class="form-control  w-100" placeholder="Mobile ">
                </div>
                <div class="form-group">
                    <input id="contactEmailId" type="text" class="form-control  w-100" placeholder="Email ">
                </div>
                <div class="form-group">
                    <input id="contactMsgId" type="text" class="form-control  w-100" placeholder="Messaage ">
                </div>
